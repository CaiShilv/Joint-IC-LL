...
def create_dataloader(dataset, dataset_opt, opt=None, sampler=None, pretrain_test=False):
    phase = dataset_opt['phase']
    if phase == 'train' or phase == 'pretrain':
        if phase == 'pretrain' and pretrain_test:
...
def create_dataset(dataset_opt):
    ...
    elif mode == 'all_data_combine':
        from data.dataset_combine import VideoSameSizeDataset as D
    else:
